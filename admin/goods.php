...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_ename, goods_ename_style, goods_name, goods_name_style, goods_sn, " .
                ...
                "VALUES ('$_POST[goods_ename]', '$goods_ename_style', '$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
    ...
    else
    {
        ...
        $sql = "UPDATE " . $ecs->table('goods') . " SET " .
				"goods_ename = '$_POST[goods_ename]', " .
                "goods_ename_style = '$goods_ename_style', " .
