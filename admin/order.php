...
function order_list()
{
    ...
    if ($result === false)
    {
        ...
        /* 查询 */
        $sql = "SELECT o.order_id, o.order_sn, o.add_time, o.ship_date, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
    ...
    foreach ($row AS $key => $value)
    {
        ...
        $row[$key]['ship_date'] = substr($value['ship_date'], 0, 11);//Add by King
