...
if (!$smarty->is_cached('article.dwt', $cache_id))
{
    ...
    $smarty->assign('artciles_list',    get_cat_articles($article['cat_id'], 1, 3,$keywords));//Add by King
	...
	$smarty->assign('content_easy', strip_tags($article['content']).'1');//Add by King
    $smarty->assign('content_img', strip_tags($article['content'] ,"<li><a><img>"));//Add by king
