...
//         return preg_replace("/{([^\}\{\n]*)}/e", "\$this->select('\\1');", $source);//本特性已自 PHP 5.5.0 起废弃。强烈建议不要使用本特性。
...
//            }
        ...
        {
            //$tag_sel = array_shift(explode(' ', $tag));// edit by King
			$tag_arr = explode(' ', $tag);//edit by King
			$tag_sel = array_shift($tag_arr);//edit by King
