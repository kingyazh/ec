...
function build_uri($app, $params, $append = '', $page = 0, $keywords = '', $size = 0)
{
    ...
    switch ($app)
    {
		...
		case 'index':
            ...
            {
                $uri = $rewrite ? 'index.php' . $cid : 'index.php?p=' . $page;
            }

            break;


		//end index page eidt by King
...
function get_volume_price_list($goods_id, $price_type = '1')
{
    ...
    foreach ($res as $k => $v)
    {
        ...
        $volume_price[$temp_index]['easy_price']   = floor($v['volume_price']);//price edit by King
 ...
 * @return  array
 */
function group_buy_list_all($size, $page)
{
	$size = 56 ; //团购 7 个便翻页 // Add by King
	$page = 1;
