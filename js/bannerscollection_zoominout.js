...
(function (e) {
        ...
        c.each(function () {
            ...
            0 < l ? a.timeouts_arr[a.timeouts_arr.length] = setTimeout(function () {
                ...
                -1 != f && 10 > f ? (c.stop().animate({opacity: t, left: h + "px", top: g + "px"}, 1E3 * l, G, function () {
                    c.css({"-webkit-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-moz-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-ms-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-o-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", transform: "skew(" + cur_skew + ") scale(" + cur_scale + ")"})
    ...
    function ba(a, b, c, p, f, n, m, h, g, l, r, t, s, q, w, u, v, y, d, D, E, z) {
        ...
        if (b.origWidth != responsiveWidth || b.width100Proc) {
            ...
            for (i = 0; i < a.total_images; i++)M(i, b, h, a.origImgsDimensions, c), t = b.fadeSlides ? 0 : parseInt(i * b.width, 10), e(e(c[i]).attr("data-text-id")).css({width: p.width() + "px", left: t, top: f.css("top")});
            m.width(holderWidth);
            "opportune" == b.skin ? (d.css({left: parseInt((h.width() - d.width()) / 2, 10) + "px", top: b.height + "px"}), b.width100Proc && b.height100Proc || d.css("margin-top", parseInt(b.thumbsWrapperMarginTop / (b.origWidth / b.width), 10) + "px")) : Y(a, b, h, r, s, q, w, u, D, E);
            g.css({left: parseInt((b.width - g.width()) / 2, 10) + "px", top: parseInt((b.height - g.height()) / 2, 10) + "px"});
            clearTimeout(a.timeoutID);
            L(a.continuouseIntervalIDs);
            1 < a.total_images ? z.click() : (e("#contentHolderUnit_" + a.current_img_no, h).html(e(c[a.previous_current_img_no]).html()), M(a.current_img_no, b, h, a.origImgsDimensions, c), H(a.timeouts_arr), e(".newFS", h).contents().unwrap(), K(a, a.currentImg, b, p, h, f, !1), b.fadeSlides && e("#contentHolderUnit_" + a.current_img_no, h).css({opacity: 1, "z-index": 0, display: "block"}), setTimeout(function () {
                S(a, b, h, l, c)
            }, 100))
        }
    ...
    e.fn.bannerscollection_zoominout = function (a) {
        ...
        return this.each(function () {
            ...
            g.css("display", "none");
            l.css("display", "none");
            a.showNavArrows && a.showOnInitNavArrows && (g.css("display", "none"), l.css("display", "none"));//相册上左右箭头默认 显示  是block 否none
            ...
            f.mouseenter(function () {
                ...
                a.autoHideBottomNav && a.showBottomNav && ("opportune" == a.skin ? r.css({display: "block", left: parseInt((f.width() - O) / 2, 10) + "px"}) : 0 > a.thumbsWrapperMarginTop && d.isVideoPlaying || !a.showBottomNav || (s.css({display: "block"}), s.stop().animate({opacity: 1}, 500, "swing", function () {
                })))
            });
            ...
            g.click(function () {
                d.slideIsRunning || (d.isVideoPlaying = !1, a.showBottomNav && (s.css({opacity: 1, display: "block"}), "opportune" == a.skin && r.css("display", "block")), clearTimeout(d.timeoutID), J(-1, d, a, C, z, b, n, h, f, y, D, B, w, u, v, x))
            });
            l.click(function () {
                d.slideIsRunning || (d.isVideoPlaying = !1, a.showBottomNav && (s.css({opacity: 1, display: "block"}), "opportune" == a.skin && r.css("display", "block")), clearTimeout(d.timeoutID), J(1, d, a, C, z, b, n, h, f, y, D, B, w, u, v, x))
            });
