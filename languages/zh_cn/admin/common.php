...
$_LANG['app_name'] = 'PinMeiSiJi';
$_LANG['cp_home'] = 'PinMeiSiJi 管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2005-2014 PinMeiSiJi 有限公司，并保留所有权利。';
...
$_LANG['auto_redirection'] = '如果您不做出选择，将在 <span id="spanSeconds">10</span> 秒后跳转到第一个链接地址。';
...
$_LANG['edit'] = '编辑';
$_LANG['view'] = '查看';
$_LANG['copy'] = '复制';//Add by King
$_LANG['ads_make_xml'] = '生成广告xml文件';//Add by King, 提示生成 xml 文件成功
$_LANG['remove'] = '移除';
$_LANG['drop'] = '删除';
