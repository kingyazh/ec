...
$_LANG['label_end_date_tip'] = '请将活动结束时间定在<span style="color:#ff0000;">结束日的23点~0点之间</span>';
...
$_LANG['groupon_desc'] = '活动描述：';//Add by King
...
$_LANG['copy_success'] = '复制团购活动成功。继续添加下一天的团购';//Add by King
