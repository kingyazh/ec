...
$_LANG['template_libs']['index_show'] = '首页主广告位 by Js';//Add by King
$_LANG['template_libs']['index_mensa'] = '首页关于品美四季简介';//Add by King
$_LANG['template_libs']['index_comments'] = '首页调用的评论';//Add by King
$_LANG['template_libs']['index_pic_menu'] = '首页3张图片的菜单链接';//Add by King
...
$_LANG['template_libs']['page_header_index'] = '首页的页面顶部';
