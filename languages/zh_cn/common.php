...
$_LANG['label_logout'] = '安全退出';//Add by King
$_LANG['new_active'] = '最新活动';//Add by King
$_LANG['profile'] = '个人资料';
...
$_LANG['the_prices'] = '价格';//Add by King
$_LANG['ship_date'] = '预定日期';//Add by King
$_LANG['deposit'] = '团购保证金';
$_LANG['amount'] = '商品总价';
$_LANG['number'] = '购买数量';
$_LANG['handle'] = '操作';
...
$_LANG['now_recommend'] = '当季推荐';//add by King
$_LANG['new_active'] = '最新活动';//add by King
$_LANG['about_mensa'] = '门店介绍';//add by King
...
$_LANG['group_goods_empty'] = '当前没有优惠活动';
...
/* // Add by King // */
$_LANG['user_comment_name'] = '昵称';
$_LANG['user_comment_time'] = '发送时间';
$_LANG['user_comment_stars'] = '等级评价';
$_LANG['user_comment_info'] = '评价详情';
/* // Add by King, end // */
$_LANG['total'] = '共';
