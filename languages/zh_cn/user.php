...
$_LANG['label_my_points'] = '我的积分';//add by King
$_LANG['label_my_cash'] = '现金券';//add by King
$_LANG['label_logout'] = '安全退出';

$_LANG['edit_pwd'] = '修改密码';//Add by King
$_LANG['user_info'] = '基本信息<br><span>Personal Information</span>';//Add by King
$_LANG['my_email'] = '我的邮箱';
$_LANG['my_nike'] = '昵　　称';
$_LANG['my_gender'] = '性　　别';
$_LANG['my_brithday'] = '生　　日';
$_LANG['my_area'] = '所在地区';
$_LANG['my_adress'] = '详细地址';
$_LANG['my_phone'] = '固定电话';
$_LANG['my_mobile'] = '手　　机';
$_LANG['my_consignee'] = '收货地址<br><span>Shipping Address</span>';
$_LANG['my_email'] = '我的邮箱';
$_LANG['my_email'] = '我的邮箱';
...
$_LANG['change_desc_a'] = '事件';//Add by King
...
$_LANG['img_type_tips'] = '<span color="red">小提示：</span>';
...
/* 登录 注册 */
$_LANG['label_username'] = '用户名 / 手机号 / 邮箱';
...
$_LANG['other_login_way'] = '您也可以使用合作网站帐号登录 PinMeiSiJi: ';
...
$_LANG['your_level'] = '%s ';//edit by King
//$_LANG['next_level'] = ',您还差 %s 积分达到 %s ';
$_LANG['next_level'] = '升级积分：%s <b style=display:none;>积分达到 %s</b> ';//edit by King
$_LANG['attention'] = '关注';
...
$_LANG['integral_rules'] = '积分规则<br><span>Integral Rules</span>';//Add by King
$_LANG['integral_rules_content'] = '<p>
			一、注册 / 验证送积分<br>
			1. 简单注册（邮箱注册或手机注册二选一）完成后送 5 个积分。<br>
			2. 完成手机验证送 5 个积分。<br>
			</p>
			<p>
			二、购买送积分<br>
			1. 消费者用人民币购买任何产品，按 1% 的比例返还积分（例如 188 元的蛋糕，返还 1.88 积分）。<br>
			2. 如已有积分抵扣，除去积分抵扣的人民币支付，还是给予1%的积分返还。（例如账户里有15元积分，购买188元的蛋糕，使用15元积分，<br>
			另付 173 元人民币，订单确认后返还 1.73 积分）。<br>
			</p>
			<p>
			三、评论送积分<br>
			1. 只有购买本款蛋糕后用户才有此款蛋糕的评论权。评论次数不限，评论需审核。<br>
			2. 用户发评论，无论对此蛋糕发多少次评论，默认前 4 条评论赠予积分。每条 1 个积分，总计 4 个积分。<br>
			</p>';//Add by King
$_LANG['integral_using_rules'] = '积分使用规则<br><span>Integration Using Rules</span>';//Add by King
$_LANG['integral_using_rules_content'] = '<p>
			一、积分兑换公司产品<br>
			1. 现金券与积分不能同时使用。<br>
			2. 累积积分 = 会员等级（参照积分等级）。当前积分 = 可用积分<br>
			3. 积分兑换礼品不免费配送，需要购买其他蛋糕一同配送。<br>
			4. 如果单独配送，每单加收额外送货费（请咨询客服人员）。<br>
			</p>';//Add by King
$_LANG['my_points_record'] = '我的积分记录<br><span>My Points Record</span>';//Add by King
$_LANG['my_points'] = '我的积分<br><span>My Points</span>';//Add by King
$_LANG['able_my_points'] = '可用积分';//Add by King
$_LANG['rank_points_a'] = '积分等级';//Add by King
